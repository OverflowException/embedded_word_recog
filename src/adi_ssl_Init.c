...
#endif         /* ADSP-BF534/5/7  */
/********************************************************************/
#if defined(__ADSP_TETON__)		// BF561 EZKit
	ADI_PWR_COMMAND_PAIR ezkit_power[] = { 

#if defined( ADI_SSL_DUAL_CORE )
    	{ ADI_PWR_CMD_SET_AUTO_SYNC_ENABLED, NULL                          }, /* enable autosync first so the cores can sync when needed */
#endif
    	{ ADI_PWR_CMD_SET_PACKAGE,      (void*)ADI_PWR_PACKAGE_MBGA        }, /* in MBGA packaging, as on all EZ-KITS */
    	{ ADI_PWR_CMD_SET_VDDEXT,       (void*)ADI_PWR_VDDEXT_330          }, /* external voltage supplied to the voltage regulator is 3.3V */
#if defined ADI_SSL_EXT_VOLTAGE_REG
	{ ADI_PWR_CMD_SET_VDDINT,       (void*)ADI_SSL_EXT_VDDINT          }, /* Externally supplied VDDINT (see adi_ssl_Init.h) */		
    	{ ADI_PWR_CMD_SET_PROC_VARIANT, (void*)ADI_PWR_PROC_BF561SKBCZ600X }, /* choose 600Mhz variant with external voltage regulator */
#else
    	{ ADI_PWR_CMD_SET_PROC_VARIANT, (void*)ADI_PWR_PROC_BF561SKBCZ500X }, /* choose 500Mhz variant with NO external voltage regulator */
#endif
    	{ ADI_PWR_CMD_SET_CLKIN,        (void*)30                          }, /* the CLKIN frequency is 30 MHz */
    	{ ADI_PWR_CMD_END,     0                                           }  /* This is the last command, there will be no more */
	}; 
...
#endif        /* ADSP-BF522/4/6  */

 


/*******************************************************************************/
#if defined(__ADSP_BRODIE__)                         /* BF518 EZKit */


ADI_PWR_COMMAND_PAIR ezkit_power[] = {	


    	{ ADI_PWR_CMD_SET_PROC_VARIANT,(void*)ADI_PWR_PROC_BF512SBBC1400  },    /* 400Mhz ADSP-BF526 */   
    	{ ADI_PWR_CMD_SET_PACKAGE,     (void*)ADI_PWR_PACKAGE_MBGA       },     /* in MBGA packaging, as on all EZ-KITS */      
    	{ ADI_PWR_CMD_SET_VDDEXT,      (void*)ADI_PWR_VDDEXT_330         },     /* external voltage supplied to the voltage regulator is 3.3V */  
	{ ADI_PWR_CMD_SET_VDDINT,      (void*)ADI_SSL_EXT_VDDINT         },	/* Externally supplied VDDINT (see adi_ssl_Init.h)*/		
    	{ ADI_PWR_CMD_SET_CLKIN,       (void*)25                         },     /* the CLKIN frequency 25 MHz */       
...
#if defined(__ADSP_BRAEMAR__) || defined(__ADSP_STIRLING__) || defined(__ADSP_MOAB__) || defined(__ADSP_KOOKABURRA__) || defined(__ADSP_MOCKINGBIRD__) || defined(__ADSP_BRODIE__) 
