...
$RCSfile: SDK-ezkitutilities.h,v $
$Revision: 1.7 $
$Date: 2011/02/21 11:11:45 $
...
#define EZ_NUM_LEDS     (3)         // number of LEDs on the board
#define EZ_NUM_BUTTONS  (2)         // number of buttons on the board
#endif
/*********************************************************************
...
extern ADI_FLAG_ID ezButtonToFlag[]; //structure containing the pf mappings for buttons
extern ADI_FLAG_ID ezLEDToFlag[];	  //structure containing the pf mappings for flags	
